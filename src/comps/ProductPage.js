      ...
      <div className="grid xgrid pgrid">
        ...
        <div className="similarprods">
          ...
          <div className="similarprodgrid">
            <Item img={products[3].img} name={products[3].name} price={products[3].price} hot={products[3].hot} sale={products[3].sale} wishlist={products[3].wishlist}/>
            <Item img={products[0].img} name={products[0].name} price={products[0].price} hot={products[0].hot} sale={products[0].sale} wishlist={products[0].wishlist}/>
            <Item img={products[7].img} name={products[7].name} price={products[7].price} hot={products[7].hot} sale={products[7].sale} wishlist={products[7].wishlist}/>
            <Item img={products[8].img} name={products[8].name} price={products[8].price} hot={products[8].hot} sale={products[8].sale} wishlist={products[8].wishlist}/>
          </div> 
        </div>
