...
function DashTableRow(props) {
  ...
  return ( 
    <tr data-purchased={props.status} onClick={() => props.openproduct(props.id,props.name,props.price,props.img,props.instock,props.color)} data-updated={props.updated}> 
      <td>{props.id}</td>
